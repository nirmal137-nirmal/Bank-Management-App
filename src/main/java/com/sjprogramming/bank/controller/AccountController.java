package com.sjprogramming.bank.controller;
...
import com.sjprogramming.bank.service.AccountService;
...
public class AccountController {
	...
	public Account getAccountByAccountNumber(@PathVariable Long accountNumber) {
	 Account account = service.getAccoutDetailsByAccountNumber(accountNumber);
		return account;
	}
